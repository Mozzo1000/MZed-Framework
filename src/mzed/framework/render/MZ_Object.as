package mzed.framework.render {
	...
	public class MZ_Object {
		...
		public function collide(object:MZ_Object):void {
			...
			var _bitData1:BitmapData = new BitmapData(_rect1.width * MZ_Base.camera.zoom, _rect1.height * MZ_Base.camera.zoom, true, 0);
			var _bitData2:BitmapData = new BitmapData(_rect2.width * MZ_Base.camera.zoom, _rect2.height * MZ_Base.camera.zoom, true, 0);
